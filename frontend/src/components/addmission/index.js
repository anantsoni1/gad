        ...
        <div className="container">
          ...
          <div className="row pt-1 px-lg-4 px-md-5">
            <div className="col-12 col-md-12 col-lg-7 col-sm-12 col-xs-12 px-lg-4 py-md-3 py-sm-5 py-xs-5 px-md-5 px-4">
              <p className="about-text">
                <p>
                  ...
                  educational experience in a very conducive environment, where
                  students excel in their academic, athletic and artistic
                  pursuits.
                </p>
                <p>
                  Children seeking admission from Grade 1 to 9 will have to take
                  a written Math and English placement test.
                </p>
                <p>
                  ...
                  school office (604-595-0888) or visit to see the Preschool in
                  action.
                </p>
                <p>
                  We invite all applying families to visit our school while
                  school is in session. We offer tours of the school to families
                  on working days. Interested families may please contact the
                  front desk to schedule a family visit.
                </p>
                <p>
                  The following information must be submitted with the
                  application: At GAD, We make our admissions process as simple
            ...
            <div className="align-items-center d-flex col-12 col-md-12 col-lg-5 col-sm-12 col-xs-12 px-lg-2 py-md-3 py-sm-2 py-xs-2 py-2 px-md-5 px-4">
              <img
                className="img-responsive-addmission"
                src={image22}
                alt={image22}
              ></img>
            </div>
            <div className="row pt-lg-5 pt-4 pb-1 px-lg-4 px-md-5">
              ...
              <div className="col-12 col-md-12 col-lg-12 col-sm-12 col-xs-12 px-lg-4 py-md-3 py-sm-5 py-xs-5 px-md-5 px-4">
                <p className="about-text">
                  <p className="pt-2">
                    <span className="font-weight-bold">STEP 1. </span> Complete
                  ...
                  <p>
                    <ul>
                      ...
                      <li>
                        Citizenship Cards/PR Cards/Immigrant Visa of the parent
                      </li>

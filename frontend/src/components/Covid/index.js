              ...
              <div className="col-lg-10 col-md-12 my-5">
                ...
                <div className="d-flex justify-content-center">
                  <button className="btn text-white text-center btn-covid-purple mt-3">
                    <a href="https://www.gadschool.com/wp-content/uploads/2021/04/April-28-2021-Restart-Safety-Plan-for-September-2021-G.A.D.-Elementary-School-1.pdf" target="_blank">
                ...
                <div className="d-flex justify-content-center">
                  <button className="btn text-white text-center btn-covid-blue my-3">
                    <a href="https://www.gadschool.com/wp-content/uploads/2021/01/FH-Back-to-school_winter-21_QA.pdf" target="_blank">

        ...
        <div className="container">
          ...
          <div className="row mt-5 mb-4">
            <div className="col-lg-6 col-md-8 col-sm-12 col-12">
              <div className="text">
                <p className="h3">Parent - Student handbook</p>
                <p>
                  To view the Parent – Student handbook, please click on the
                  button below:
                </p>
              </div>
            </div>
          ...
          <div className="row my-4">
            <div className="col-lg-6 col-md-8 col-sm-12 col-12">
              <div className="text">
                <p className="h3">Anaphylaxis Policy</p>
                <p>
                  To view the Anaphylaxis Policy file, please click on the
                  button below:
                </p>
              </div>
            </div>
          ...
          <div className="row my-4">
            <div className="col-lg-6 col-md-8 col-sm-12 col-12">
              <div className="text">
                <p className="h3">Supervision Policy</p>
                <p>
                  To view the GAD Supervision Policy, please click on the button
                  below:
                </p>
              </div>
            </div>
          ...
          <div className="row my-4">
            <div className="col-lg-6 col-md-8 col-sm-12 col-12">
              <div className="text">
                <p className="h3">Safe and Caring School</p>
                <p>
                  To view the School Safe and Caring policy, please click on the
                  button below:
                </p>
              </div>
            </div>
          ...
          <div className="row my-4">
            <div className="col-lg-6 col-md-8 col-sm-12 col-12">
              <div className="text">
                <p className="h3">Emergency Preparedness Manual</p>
                <p>
                  To view the GAD Emergency Preparedness Manual, please click on
                  the button below:
                </p>
              </div>
            </div>
